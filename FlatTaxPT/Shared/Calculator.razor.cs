...
public partial class Calculator
{
    ...
    public string SocialSharingMessage =>
        $"Com a Flat Tax da Iniciativa Liberal, vou ganhar mais {RaiseInPercentage:P2} por mês do que com os atuais escalões de IRS";
